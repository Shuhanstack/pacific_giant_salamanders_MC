...
There is no significant effect of forest conditions (GO/CC) on where in the channel salamanders are located (cascades/pool/side-channel) ($\chi$^2^(`r chi_2017$parameter`) = `r round(chi_2017$statistic,2)`, *p* = `r round(chi_2017$p.value, 2)`). Salamanders from old growth and clear cut sections in the forest have no different chances to be spotted in cascades (OG = `r props_2017[[2, 2]]`, CC = `r  props_2017[[1, 2]]`), pool (OG = `r props_2017[[2, 3]]`, CC = `r props_2017[[1, 2]]`), and side-chanel (OG = `r props_2017[[2, 4]]`, CC = `r props_2017[[1, 4]]`).
